...
public class ParserEn implements Parser{
	...
	public engine.ParserOutput parse(String command, Inventory inv) throws Exception {
        ...
        case 2 : 
        	//verbo oggetto
        	String com = checkInDictionary(tokens[1], "commands.txt");
        	if(com != null) {
            	String obj = checkInDictionary(tokens[2], "objects.txt");
            	if(obj != null) {
        ...
        case 3 : 
        	...
        	String com1 = checkInDictionary(tokens[1], "commands.txt");
        	if(com1 != null) {
        		String art = checkInDictionary(tokens[2], "articles.txt");
        		if(art != null) {
		        	String obj = checkInDictionary(tokens[3], "objects.txt");
		        	if(obj != null) {
        ...
        case 4 :
        	...
        	String com2 = checkInDictionary(tokens[1], "commands.txt");
        	if(com2 != null) {
            	String obj = checkInDictionary(tokens[2], "objects.txt");
            	if(obj != null) {
            		String prep = checkInDictionary(tokens[3], "prepositions.txt");
            		if(prep != null) {
                    	String obj1 = checkInDictionary(tokens[4], "objects.txt");
                    	if(obj == null) {
        ...
        case 5 : 
        	...
        	String com3 = checkInDictionary(tokens[1], "commands.txt");
        	if(com3 != null) {
        		String art = checkInDictionary(tokens[2], "articles.txt");
        		if(art != null) {
		        	String obj = checkInDictionary(tokens[3], "objects.txt");
		        	if(obj != null) {
		        		String prep = checkInDictionary(tokens[4], "prepositions.txt");
	            		if(prep != null) {
	                    	String obj1 = checkInDictionary(tokens[5], "objects.txt");
	                    	if(obj == null) {
